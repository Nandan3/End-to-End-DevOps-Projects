Follow the steps below:
	...
	§ Resize File system: (if running out of space while creating the application)
		...
		2. Change the file system in CLI
		 $lsblk
...
More detailed steps, refer my blog: [https://dev.to/nandan_007/containerize-and-run-an-e-commerce-based-application-in-aws-eks-cluster-with-all-best-practices-348o](https://dev.to/nandan_007/containerize-and-run-an-e-commerce-based-application-in-aws-eks-cluster-using-terraform-with-all-1oei)
